...
<head>
    ...
    <script src="<%=NetUtils.getBasePath(request) %>resource/js/header.js"></script><%--里面有checkBeforeSubmit()函数--%>
    <script>
...
<body>
<form action="<%=NetUtils.getBasePath(request) %>login.action" id="form_login" onsubmit="return checkBeforeLogin();">
    <dl class="admin_login">
        ...
        <dd class="user_icon">
            <input type="text" placeholder="账号" minlength="4" maxlength="30" name="username" class="login_txtbx" required="required"/>
        </dd>
        <dd class="pwd_icon">
